    ...
    <div className="relative" style={{ minHeight: '500vh' }}>
      ...
      >
        <div className="max-w-4xl mx-auto relative z-20">
          ...
          <div className="max-w-4xl mx-auto bg-[#81ecec]/10 border-2 border-[#81ecec]/70 shadow-xl shadow-[#81ecec]/50 ring-2 ring-[#81ecec]/40 bg-gradient-to-br from-[#81ecec]/15 via-deep-black/80 to-[#81ecec]/20 hover:border-[#81ecec]/90 hover:shadow-[#81ecec]/70 transition-all duration-300 rounded-lg p-6">
      ...
      >
        <div className="max-w-5xl mx-auto relative z-20">
          ...
          <div className="bg-[#81ecec]/10 border-2 border-[#81ecec]/70 shadow-xl shadow-[#81ecec]/50 ring-2 ring-[#81ecec]/40 bg-gradient-to-br from-[#81ecec]/15 via-deep-black/80 to-[#81ecec]/20 hover:border-[#81ecec]/90 hover:shadow-[#81ecec]/70 transition-all duration-300 rounded-lg p-8">
            <motion.h2 
      ...
      >
        <div className="max-w-4xl mx-auto relative z-20">
          <motion.div 
            ...
            transition={{ duration: 1 }}
          >
            <h2 className="font-angle text-3xl md:text-4xl font-bold text-ancient-gold mb-3" style={{ textShadow: '0 0 8px rgba(212, 175, 55, 0.8), 0 0 16px rgba(212, 175, 55, 0.4), 2px 2px 4px rgba(0,0,0,0.8)' }}>
          ...
          <div className="grid md:grid-cols-2 gap-3">
            {scienceConcepts.map((concept, index) => {
              ...
              return (
                ...
                >
                  <Card className="bg-[#81ecec]/10 border-2 border-[#81ecec]/70 shadow-xl shadow-[#81ecec]/50 ring-2 ring-[#81ecec]/40 bg-gradient-to-br from-[#81ecec]/15 via-deep-black/80 to-[#81ecec]/20 h-full hover:border-[#81ecec]/90 hover:shadow-[#81ecec]/70 transition-all duration-300">
                    <CardContent className="p-3 text-center">
                      ...
                      <h3 className={`typography-h4 font-bold mb-2 tracking-wider text-glow-gold ${concept.color === 'crimson' ? 'text-crimson' : concept.color === 'mystical-teal' ? 'text-mystical-teal' : concept.color === 'ancient-gold' ? 'text-ancient-gold' : 'text-cream-white'}`}>
                        {concept.title}
                      </h3>
                      <p className="font-kardige text-lg text-cream-white leading-relaxed" style={{ textShadow: '0 0 3px rgba(0, 0, 0, 0.8), 0 0 6px rgba(0, 0, 0, 0.75), 0 0 12px rgba(0, 0, 0, 0.7), 0 0 18px rgba(0, 0, 0, 0.65), 0 0 24px rgba(0, 0, 0, 0.6)' }}>
                        {concept.description}
                      </p>
                    </CardContent>
                  </Card>
