    ...
    <div className="relative" style={{ minHeight: '500vh' }}>
      ...
      >
        <div className="max-w-4xl mx-auto relative z-20">
          ...
          <div className="max-w-4xl mx-auto backdrop-blur-lg bg-mystical-teal/5 border border-mystical-teal/20 shadow-2xl shadow-mystical-teal/20 hover:bg-mystical-teal/10 hover:border-mystical-teal/30 hover:shadow-mystical-teal/30 transition-all duration-300 rounded-lg p-6">
      ...
      >
        <div className="max-w-5xl mx-auto relative z-20">
          ...
          <div className="backdrop-blur-lg bg-mystical-teal/5 border border-mystical-teal/20 shadow-2xl shadow-mystical-teal/20 hover:bg-mystical-teal/10 hover:border-mystical-teal/30 hover:shadow-mystical-teal/30 transition-all duration-300 rounded-lg p-8">
            <motion.h2 
