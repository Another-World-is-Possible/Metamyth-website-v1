                  ...
                  <CardContent className="p-8">
                    <div className="flex items-start gap-6">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-2xl text-silver/80 mb-2 italic font-kardige">
                          {phase.subtitle}
                        </p>
                        ...
                        <div className="grid md:grid-cols-2 gap-4 mb-4">
                          <div>
                            ...
                            <ul className="space-y-1">
                              {phase.movements.map((movement, idx) => (
                                <li key={idx} className="text-silver/90 text-lg flex items-start gap-2 font-kardige">
                          ...
                          <div className="bg-deep-black/60 border-2 border-ancient-gold/60 rounded-lg p-4 shadow-lg shadow-ancient-gold/30">
                            ...
                            <p className="text-silver text-lg font-medium leading-relaxed font-kardige" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.8)' }}>
                              {phase.outcome}
                            </p>
                          </div>
                        </div>
        ...
        >
          <Card className="bg-[#81ecec]/10 backdrop-blur-lg border-2 border-[#81ecec]/70 shadow-xl shadow-[#81ecec]/50 ring-2 ring-[#81ecec]/40 bg-gradient-to-br from-[#81ecec]/15 via-deep-black/80 to-[#81ecec]/20 hover:border-[#81ecec]/90 hover:shadow-[#81ecec]/70 transition-all duration-300">
            <CardContent className="p-8">
              ...
              <p className="font-kardige text-xl text-silver leading-relaxed mb-6 max-w-4xl mx-auto">
