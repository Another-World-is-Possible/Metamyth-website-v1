    ...
    <div className="relative min-h-screen py-20 pt-32">
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          ...
          <h2 className="typography-h2 text-ancient-gold font-bold mb-4" style={{ textShadow: '0 0 6px rgba(0, 0, 0, 1), 0 0 12px rgba(0, 0, 0, 1), 0 0 24px rgba(0, 0, 0, 1), 0 0 48px rgba(0, 0, 0, 0.8)' }}>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="grid md:grid-cols-2 gap-4 mb-4">
                          ...
                          <div className="bg-deep-black/60 border-2 border-ancient-gold rounded-lg p-4 shadow-lg shadow-ancient-gold/50">
                            ...
                            <p className="text-cream-white text-lg font-medium leading-relaxed font-kardige" style={{ textShadow: '0 0 4px rgba(0,0,0,1), 0 0 8px rgba(0,0,0,1), 0 0 16px rgba(0,0,0,1), 0 0 32px rgba(0,0,0,0.8)' }}>
                              {phase.outcome}
                            </p>
                          </div>
                        </div>
              ...
              >
                <Card className="bg-[#81ecec]/10 border-2 border-[#81ecec]/70 shadow-xl shadow-[#81ecec]/50 ring-2 ring-[#81ecec]/40 bg-gradient-to-br from-[#81ecec]/15 via-deep-black/80 to-[#81ecec]/20 hover:border-[#81ecec]/90 hover:shadow-[#81ecec]/70 transition-all duration-300 h-full">
                  <CardContent className="p-6">
                    <h4 className="font-bold text-ancient-gold mb-3 text-2xl" style={{ textShadow: '0 0 8px currentColor, 0 0 4px rgba(0,0,0,1), 0 0 8px rgba(0,0,0,1), 0 0 16px rgba(0,0,0,1), 0 0 32px rgba(0,0,0,0.8)' }}>
                      {result.title}
                    </h4>
                    <p className="text-cream-white text-lg font-kardige" style={{ textShadow: '0 0 4px rgba(0,0,0,1), 0 0 8px rgba(0,0,0,1), 0 0 16px rgba(0,0,0,1), 0 0 32px rgba(0,0,0,0.8)' }}>
                      {result.description}
                    </p>
                  </CardContent>
                </Card>
            ...
            <CardContent className="p-8">
              <div className="flex items-center justify-center mb-6">
                ...
                <h3 
                  ...
                  style={{ textShadow: '0 0 8px rgba(129, 236, 236, 0.8), 0 0 16px rgba(129, 236, 236, 0.4), 0 0 4px rgba(0,0,0,1), 0 0 8px rgba(0,0,0,1), 0 0 16px rgba(0,0,0,1), 0 0 32px rgba(0,0,0,0.8)' }}
                >
                  THE LARGER VISION
                </h3>
              </div>
