        ...
        <div className="space-y-8">
          {questHorizons.map((horizon, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="backdrop-blur-lg border-2 border-[#81ecec]/70 shadow-xl shadow-[#81ecec]/50 ring-2 ring-[#81ecec]/40 bg-gradient-to-br from-[#81ecec]/15 via-deep-black/80 to-[#81ecec]/20 hover:border-[#81ecec]/90 hover:shadow-[#81ecec]/70 transition-all duration-300 p-8">
                <motion.div
