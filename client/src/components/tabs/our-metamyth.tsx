          ...
          <Accordion type="single" collapsible className="space-y-6">
            {accordionItems.map((item, index) => (
              <AccordionItem 
                key={item.id}
                value={item.id}
className="backdrop-blur-lg border-2 border-[#81ecec]/70 shadow-xl shadow-[#81ecec]/50 ring-2 ring-[#81ecec]/40 bg-gradient-to-br from-[#81ecec]/15 via-deep-black/80 to-[#81ecec]/20 rounded-lg overflow-hidden hover:border-[#81ecec]/90 hover:shadow-[#81ecec]/70 transition-all duration-300"
              >
