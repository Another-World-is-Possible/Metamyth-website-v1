    ...
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h3 className="typography-h3 font-angle text-ancient-gold mb-4 text-center">THE CALLING</h3>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h3 className="typography-h3 font-angle text-ancient-gold mb-4 text-center">THE QUEST</h3>
          <p className="typography-body text-cream-white leading-relaxed text-center" style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 0.8)' }}>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h3 className="typography-h3 font-angle text-ancient-gold mb-4 text-center">THE VISION</h3>
          <p className="typography-body text-cream-white leading-relaxed text-center" style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 0.8)' }}>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h3 className="typography-h3 font-angle text-ancient-gold mb-4 text-center">THE MISSION</h3>
          <p className="typography-body text-cream-white leading-relaxed text-center" style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 0.8)' }}>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h3 className="typography-h3 font-angle text-ancient-gold mb-4 text-center">THE REQUEST</h3>
          <p className="typography-body text-cream-white leading-relaxed text-center" style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 0.8)' }}>
