      ...
      <CardContent className="p-8">
        ...
        {selectedHorizon && (
          <motion.div
            ...
            className="mt-8"
          >
            <Card className={`backdrop-blur-lg bg-mystical-teal/5 border border-mystical-teal/20 shadow-2xl shadow-mystical-teal/20 hover:bg-mystical-teal/10 hover:border-mystical-teal/30 hover:shadow-mystical-teal/30 transition-all duration-300 ${timelineData[selectedHorizon - 1]?.color === 'crimson' ? 'border-crimson/30' : 
