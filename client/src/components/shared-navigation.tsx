            ...
            {audioControls && (
              <div className="relative ml-2" ref={audioControlsRef}> {/* Added ml-2 here */}
                <button
                  ...
                  className="bg-black/50 backdrop-blur-sm border border-ancient-gold/30 rounded-full p-2 text-ancient-gold transition-all duration-300 hover:!bg-[hsl(45,85%,55%,0.4)] hover:!border-[hsl(45,85%,55%,0.6)] hover:!text-black"
              ...
              <div className="relative ml-2" ref={profileControlsRef}>
                <button
                  ...
                  className={`backdrop-blur-sm rounded-full p-2 transition-all duration-300 ${
                    user 
                      ? 'bg-black/50 border border-ancient-gold/30 text-ancient-gold hover:!bg-[hsl(45,85%,55%,0.4)] hover:!border-[hsl(45,85%,55%,0.6)] hover:!text-black'
