...
<body class="crimson-portal">
    <div class="p-8 max-w-md w-full mx-4" style="background-color: #4a0000 !important; border: 2px solid #14b8a6 !important; border-radius: 16px !important; box-shadow: 0 0 15px rgba(20, 184, 166, 0.6), 0 0 30px rgba(20, 184, 166, 0.4), inset 0 0 20px rgba(74, 0, 0, 0.8) !important; backdrop-filter: blur(10px) !important;">
        ...
        <form onsubmit="handleSubmit(event)" class="space-y-6">
            <div>
                ...
                <input 
                    ...
                    style="background-color: rgba(255, 255, 255, 0.1) !important; border: 1px solid rgba(255, 255, 255, 0.3) !important; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.2) !important;"
